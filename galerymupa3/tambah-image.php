...
echo '<select class="input-control" name="jurusan" onchange="document.getElementById(\'prd_name\').value = prdName[this.value]" required>  <option>-Pilih jurusan Foto-</option>';while ($row = mysqli_fetch_array($result)) {  echo ' <option value="' . $row['jurusan_id'] . '">' . $row['jurusan_name'] . '</option>';  
